...
public class TC_JOOMLA_ARTICLE_015_VerifyUserCanChangeTheStatusOfArticlesUsingTheStatusColumn extends Action {
  ...
  public void Login() {
	  ...
	  page.enterTitle(Constant.tc015Article.Title);
	  
	  Log.info("Step 8: Select an item from the 'Category' dropdown list");
	  page.selectCategoryInCategory(Constant.tc015Article.Category);
	   
	  Log.info("Step 9: Select 'Published' item from 'Status' dropdown list");
	  page.selectItemStatus(Constant.tc015Article.StatusPublish);
	  
	  Log.info("Step 10: Enter value on 'Article Text' text area");
	  page.enterAtArticleText(Constant.tc015Article.Content);
	  ...
	  article.checkOnCheckBox(Constant.tc015Article.Title);
