...
public class TC_JOOMLA_BANNERS_004_VerifyThatUserCanUnpublishABanner extends Action {
  ...
  public void Login() {
	  ...
	  newClients.enterClientName(Constant.tc004Banners.ClientsName);
	  
	  Log.info("Step 7: Enter valid Contact Name to Contact Name textbox");
	  newClients.enterContactName(Constant.tc004Banners.ContactName);
	  
	  Log.info("Step 8: Enter valid Contact Email to Contact Email textbox");
	  newClients.enterContactEmail(Constant.tc004Banners.ContactEmail);
	  ...
	  verifyTrue(clients.checkClientsCreated(Constant.tc004Banners.ClientsName));
	  ...
	  newCategories.enterTitleCategories(Constant.tc004Banners.CategoryName);
	  ...
	  verifyTrue(categories.checkCategoriesCreated(Constant.tc004Banners.CategoryName));
	  ...
	  newBanners.enterTxbNameBanners(Constant.tc004Banners.BannersName);
	  
	  Log.info("Step 19: Select a Category in Category dropdown list");
	  newBanners.selectFiledOfDownListCategory(Constant.tc004Banners.CategoryName);
	  
	  Log.info("Step 20: Select a Client in Client dropdown list");
	  newBanners.clickTab(Constant.tc002Banners.tab);
	  newBanners.selectFiledOfDownListClient(Constant.tc004Banners.ClientsName);
	  ...
	  verifyTrue(banner.checkBannersCreated(Constant.tc004Banners.BannersName));
	  
	  Log.info("Step 23: Check the banner recently created");
	  banner.clickCheckBox(Constant.tc004Banners.BannersName);
	  
	  Log.info("Step 24: Click 'Unpublish' button in the right top corner");
	  banner.clickBtnUnpublish();
	  
	  Log.info(" Verify point : A message : 'Banners successfully saved' shows and new Banners is created");
	  verifyTrue(banner.checkMessageChangedUnpublishSuccessfully());
	  verifyTrue(banner.checkIconStatus(Constant.tc004Banners.BannersName, Constant.tc004Banners.StatusIcon));
