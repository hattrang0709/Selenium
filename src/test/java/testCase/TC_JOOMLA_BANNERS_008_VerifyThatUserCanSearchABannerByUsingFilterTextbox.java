...
public class TC_JOOMLA_BANNERS_008_VerifyThatUserCanSearchABannerByUsingFilterTextbox extends Action {
  ...
  public void Login() {
	  ...
	  newClients.enterClientName(Constant.tc008Banners.ClientsName);
	  
	  Log.info("Step 7: Enter valid Contact Name to Contact Name textbox");
	  newClients.enterContactName(Constant.tc008Banners.ContactName);
	  
	  Log.info("Step 8: Enter valid Contact Email to Contact Email textbox");
	  newClients.enterContactEmail(Constant.tc008Banners.ContactEmail);
	  ...
	  verifyTrue(clients.checkClientsCreated(Constant.tc008Banners.ClientsName));
	  ...
	  newCategories.enterTitleCategories(Constant.tc008Banners.CategoryName);
	  ...
	  verifyTrue(categories.checkCategoriesCreated(Constant.tc008Banners.CategoryName));
	  ...
	  newBanners.enterTxbNameBanners(Constant.tc008Banners.BannersName);
	  
	  Log.info("Step 19: Select a Category in Category dropdown list");
	  newBanners.selectFiledOfDownListCategory(Constant.tc008Banners.CategoryName);
	  
	  Log.info("Step 20: Select a Client in Client dropdown list");
	  newBanners.clickTab(Constant.tc002Banners.tab);
	  newBanners.selectFiledOfDownListClient(Constant.tc008Banners.ClientsName);
	  ...
	  verifyTrue(banner.checkBannersCreated(Constant.tc008Banners.BannersName));
	  
	  Log.info("Step 23: Enter valid Banner Name to Filter textbox");
	  banner.enterTxbSearch(Constant.tc008Banners.BannersName);
	  
	  Log.info("Step 24: Click 'Search' button");
	  banner.clickIconSearch();
