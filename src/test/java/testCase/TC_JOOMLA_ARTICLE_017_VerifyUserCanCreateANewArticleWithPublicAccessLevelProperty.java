...
public class TC_JOOMLA_ARTICLE_017_VerifyUserCanCreateANewArticleWithPublicAccessLevelProperty extends Action {
  ...
  public void Login() {
	  ...
	  page.enterTitle(Constant.tc017Article.Title);
	  
	  Log.info("Step 8: Select an item from the 'Category' dropdown list");
	  page.selectCategoryInCategory(Constant.tc017Article.Category);
	    
	  Log.info("Step 9: Enter value on 'Article Text' text area");
	  page.enterAtArticleText(Constant.tc017Article.Content);
	  
	  Log.info("Step 10: Select 'Public' item from the 'Access' dropdown list");
	  page.selecAccesstDownList(Constant.tc017Article.FiledAccess);
	  ...
	  verifyTrue(article.articleNameDisplay(Constant.tc017Article.Title));
	  verifyTrue(article.isFiledNameAccess(Constant.tc017Article.Title, Constant.tc017Article.FiledAccess));
  }
