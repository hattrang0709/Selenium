...
public class TC_JOOMLA_BANNERS_006_VerifyThatUserCanSendABannerToTrash extends Action {
  ...
  public void Login() {
	  ...
	  newClients.enterClientName(Constant.tc006Banners.ClientsName);
	  
	  Log.info("Step 7: Enter valid Contact Name to Contact Name textbox");
	  newClients.enterContactName(Constant.tc006Banners.ContactName);
	  
	  Log.info("Step 8: Enter valid Contact Email to Contact Email textbox");
	  newClients.enterContactEmail(Constant.tc006Banners.ContactEmail);
	  ...
	  newCategories.enterTitleCategories(Constant.tc006Banners.CategoryName);
	  ...
	  newBanners.enterTxbNameBanners(Constant.tc006Banners.BannersName);
	  
	  Log.info("Step 19: Select a Category in Category dropdown list");
	  newBanners.selectFiledOfDownListCategory(Constant.tc006Banners.CategoryName);
	  
	  Log.info("Step 20: Select a Client in Client dropdown list");
	  newBanners.clickTab(Constant.tc002Banners.tab);
	  newBanners.selectFiledOfDownListClient(Constant.tc006Banners.ClientsName);
	  ...
	  banner.clickCheckBox(Constant.tc006Banners.BannersName);
