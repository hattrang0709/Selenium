...
public class TC_JOOMLA_BANNERS_003_VerifyThatUserCanCreateANewBannerWithUnpublishedStatus extends Action {
  ...
  public void Login() {
	  ...
	  newClients.enterClientName(Constant.tc003Banners.ClientsName);
	  
	  Log.info("Step 7: Enter valid Contact Name to Contact Name textbox");
	  newClients.enterContactName(Constant.tc003Banners.ContactName);
	  
	  Log.info("Step 8: Enter valid Contact Email to Contact Email textbox");
	  newClients.enterContactEmail(Constant.tc003Banners.ContactEmail);
	  ...
	  newCategories.enterTitleCategories(Constant.tc003Banners.CategoryName);
	  ...
	  newBanners.enterTxbNameBanners(Constant.tc003Banners.BannersName);
	  
	  Log.info("Step 19: Select a Category in Category dropdown list");
	  newBanners.selectFiledOfDownListCategory(Constant.tc003Banners.CategoryName);
	  
	  Log.info("Step 20: Select a Client in Client dropdown list");
	  newBanners.clickTab(Constant.tc002Banners.tab);
	  newBanners.selectFiledOfDownListClient(Constant.tc003Banners.ClientsName);
	  
	  Log.info("Step 21: Select 'Unpublished' in Status dropdown list");
	  newBanners.clickTab(Constant.tc003Banners.tab1);
	  newBanners.selectFiledOfDownListStatus(Constant.tc003Banners.StatusFiled);
