...
public class TC_JOOMLA_BANNERS_001_VerifyThatUserCanCreateNewBanner extends Action {
  ...
  public void Login() {
	  ...
	  newClients.enterClientName(Constant.tc001Banners.ClientsName);
	  
	  Log.info("Step 7: Enter valid Contact Name to Contact Name textbox");
	  newClients.enterContactName(Constant.tc001Banners.ContactName);
	  
	  Log.info("Step 8: Enter valid Contact Email to Contact Email textbox");
	  newClients.enterContactEmail(Constant.tc001Banners.ContactEmail);
	  ...
	  verifyTrue(clients.checkClientsCreated(Constant.tc001Banners.ClientsName));
	  ...
	  newCategories.enterTitleCategories(Constant.tc001Banners.CategoryName);
	  ...
	  verifyTrue(categories.checkCategoriesCreated(Constant.tc001Banners.CategoryName));
	  ...
	  newBanners.enterTxbNameBanners(Constant.tc001Banners.BannersName);
	  
	  Log.info("Step 19: Select a Category in Category dropdown list");
	  newBanners.selectFiledOfDownListCategory(Constant.tc001Banners.CategoryName);
	  
	  Log.info("Step 20: Enter valid Name to Name textbox");
	  newBanners.enterTxbNameBanners(Constant.tc001Banners.BannersName);
	  
	  Log.info("Step 21: Select a Client in Client dropdown list");
	  newBanners.clickTab(Constant.tc001Banners.tab);
	  newBanners.selectFiledOfDownListClient(Constant.tc001Banners.ClientsName);
	  ...
	  verifyTrue(banner.checkBannersCreated(Constant.tc001Banners.BannersName));
  }
