...
public class TC_JOOMLA_ARTICLE_004_VerifyUserCanUnpublishAPublishedArticle extends Action {
  ...
  public void Login() {
	  ...
	  page.enterTitle(Constant.tc004Article.Title);
	  
	  Log.info("Step 8: Select an item from the 'Category' dropdown list");
	  page.selectCategoryInCategory(Constant.tc004Article.Category);
	    
	  Log.info("Step 9: Select 'Published' item from 'Status' dropdown list");
	  page.selectItemStatus(Constant.tc004Article.StatusPublish);
	  
	  Log.info("Step 10: Enter value on 'Article Text' text area");
	  page.enterAtArticleText(Constant.tc004Article.Content);
	  ...
	  article.checkOnCheckBox(Constant.tc004Article.Title);;
