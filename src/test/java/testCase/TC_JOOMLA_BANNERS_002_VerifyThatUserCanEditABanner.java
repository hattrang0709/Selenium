...
public class TC_JOOMLA_BANNERS_002_VerifyThatUserCanEditABanner extends Action {
  ...
  public void Login() {
	  ...
	  newClients.enterClientName(Constant.tc002Banners.ClientsName);
	  
	  Log.info("Step 7: Enter valid Contact Name to Contact Name textbox");
	  newClients.enterContactName(Constant.tc002Banners.ContactName);
	  
	  Log.info("Step 8: Enter valid Contact Email to Contact Email textbox");
	  newClients.enterContactEmail(Constant.tc002Banners.ContactEmail);
	  ...
	  verifyTrue(clients.checkClientsCreated(Constant.tc002Banners.ClientsName));
	  ...
	  newCategories.enterTitleCategories(Constant.tc002Banners.CategoryName);
	  ...
	  verifyTrue(categories.checkCategoriesCreated(Constant.tc002Banners.CategoryName));
	  ...
	  newBanners.enterTxbNameBanners(Constant.tc002Banners.BannersName1);
	  
	  Log.info("Step 19: Select a Category in Category dropdown list");
	  newBanners.selectFiledOfDownListCategory(Constant.tc002Banners.CategoryName);
	  
	  Log.info("Step 20: Enter valid Name to Name textbox");
	  newBanners.enterTxbNameBanners(Constant.tc002Banners.BannersName1);
	  
	  Log.info("Step 21: Select a Client in Client dropdown list");
	  newBanners.clickTab(Constant.tc002Banners.tab);
	  newBanners.selectFiledOfDownListClient(Constant.tc002Banners.ClientsName);
	  
	  Log.info("Step 22: Click 'Save' button");
	  newBanners.clickBtnSave();
	  
	  Log.info(" Verify point : A message : 'Banners successfully saved' shows and new Banners is created");
	  System.out.println(newBanners.checkAtBannersNewPage());
	  verifyTrue(newBanners.checkMessageSavedSuccessfully());
	  verifyTrue(newBanners.checkAtBannersNewPage());
	  
	  Log.info("Step 24: Enter valid Name to Name textbox");
	  newBanners.enterTxbNameBanners(Constant.tc002Banners.BannersName2);
	  
	  Log.info("Step 15: Click 'Save & Close' button");
	  newCategories.clickBtnSaveAndClose();
	  
	  Log.info(" Verify point : A message : 'Banners successfully saved' shows and new Banners is created");
	  verifyTrue(banner.checkMessageSavedSuccessfully());
	  verifyTrue(banner.checkBannersCreated(Constant.tc002Banners.BannersName2));
  }
