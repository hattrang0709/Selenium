...
public class TC_JOOMLA_BANNERS_010_VerifyThatUserCanCheckInABanner extends Action {
  ...
  public void Login() {
	  ...
	  newClients.enterClientName(Constant.tc010Banners.ClientsName);
	  
	  Log.info("Step 7: Enter valid Contact Name to Contact Name textbox");
	  newClients.enterContactName(Constant.tc010Banners.ContactName);
	  
	  Log.info("Step 8: Enter valid Contact Email to Contact Email textbox");
	  newClients.enterContactEmail(Constant.tc010Banners.ContactEmail);
	  ...
	  newCategories.enterTitleCategories(Constant.tc010Banners.CategoryName);
	  ...
	  newBanners.enterTxbNameBanners(Constant.tc010Banners.BannersName);
	  
	  Log.info("Step 19: Select a Category in Category dropdown list");
	  newBanners.selectFiledOfDownListCategory(Constant.tc010Banners.CategoryName);
	  
	  Log.info("Step 20: Select a Client in Client dropdown list");
	  newBanners.clickTab(Constant.tc002Banners.tab);
	  newBanners.selectFiledOfDownListClient(Constant.tc010Banners.ClientsName);
  ...
  @Test
  public void Login1() {
	  Log.info("Step 24: Navigate to the URL to Joomla Login page");
	  home.goHomePage(Configure.url);
	  
	  Log.info("Step 25: Login with User Name  and password ");
	  login.loginAccount(Constant.loginData.UserName, Constant.loginData.pass);
	  
	  Log.info("Step 26: Click on 'Log in' button");
	  login.clickBtnLogin();
	  ...
	  banner.clickCheckBox(Constant.tc010Banners.BannersName);
