...
public class TC_JOOMLA_BANNERS_005_VerifyThatUserCanArchiveABanner extends Action {
  ...
  public void Login() {
	  ...
	  newClients.enterClientName(Constant.tc005Banners.ClientsName);
	  
	  Log.info("Step 7: Enter valid Contact Name to Contact Name textbox");
	  newClients.enterContactName(Constant.tc005Banners.ContactName);
	  
	  Log.info("Step 8: Enter valid Contact Email to Contact Email textbox");
	  newClients.enterContactEmail(Constant.tc005Banners.ContactEmail);
	  ...
	  newCategories.enterTitleCategories(Constant.tc005Banners.CategoryName);
	  ...
	  newBanners.enterTxbNameBanners(Constant.tc005Banners.BannersName);
	  
	  Log.info("Step 19: Select a Category in Category dropdown list");
	  newBanners.selectFiledOfDownListCategory(Constant.tc005Banners.CategoryName);
	  
	  Log.info("Step 20: Select a Client in Client dropdown list");
	  newBanners.clickTab(Constant.tc002Banners.tab);
	  newBanners.selectFiledOfDownListClient(Constant.tc005Banners.ClientsName);
	  ...
	  banner.clickCheckBox(Constant.tc005Banners.BannersName);
